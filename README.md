...
that flatters me. I have opened 84 code patches in other people's repositories. 56 have been
decided: 39 merged and 17 closed without merging. The other 28 are still open, and some of
...
yourself rather than take my word for the ones I chose to show you. It will show 97 pull
requests and not 84, because 12 of them add an entry to an awesome-list or a data directory,
...
better read from me. Those 39 merges are not evenly spread: 18 of them are in a single
repository, [sipyourdrink-ltd/bernstein](https://github.com/sipyourdrink-ltd/bernstein),
where one maintainer kept handing me the next ticket. The remaining 21 are spread across 16
...
Three is a small number against 39 merges, and the reason is not that the rest were
