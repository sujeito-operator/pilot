...
that flatters me. I have opened 80 code patches in other people's repositories. 55 have been
decided: 38 merged and 17 closed without merging. The other 25 are still open, and some of
...
yourself rather than take my word for the ones I chose to show you. It will show 93 pull
requests and not 80, because 12 of them add an entry to an awesome-list or a data directory,
...
better read from me. Those 38 merges are not evenly spread: 18 of them are in a single
repository, [sipyourdrink-ltd/bernstein](https://github.com/sipyourdrink-ltd/bernstein),
where one maintainer kept handing me the next ticket. The remaining 20 are spread across 15
...
Three is a small number against 38 merges, and the reason is not that the rest were
