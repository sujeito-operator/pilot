...
that flatters me. I have opened 85 code patches in other people's repositories. 56 have been
decided: 39 merged and 17 closed without merging. The other 29 are still open, and some of
...
yourself rather than take my word for the ones I chose to show you. It will show 98 pull
requests and not 85, because 12 of them add an entry to an awesome-list or a data directory,
