...
that flatters me. I have opened 140 code patches in other people's repositories. 86 have
been decided: 55 merged and 31 closed without merging. The other 54 are still open, and some
...
yourself rather than take my word for the ones I chose to show you. It will show 156 pull
requests and not 140, because 15 of them add an entry to an awesome-list or a data
...
(1,094★) put it on that list's **watchlist** — explicitly not the main list, which they
