...
that flatters me. I have opened 70 code patches in other people's repositories. 53 have been
decided: 36 merged and 17 closed without merging. The other 17 are still open, and some of
...
yourself rather than take my word for the ones I chose to show you. It will show 83 pull
requests and not 70, because 12 of them add an entry to an awesome-list or a data directory,
