...
that flatters me. I have opened 105 code patches in other people's repositories. 69 have
been decided: 44 merged and 25 closed without merging. The other 36 are still open, and some
...
yourself rather than take my word for the ones I chose to show you. It will show 119 pull
requests and not 105, because 13 of them add an entry to an awesome-list or a data
...
(1,085★) put it on that list's **watchlist** — explicitly not the main list, which they
