...
that flatters me. I have opened 132 code patches in other people's repositories. 81 have
been decided: 53 merged and 28 closed without merging. The other 51 are still open, and some
...
yourself rather than take my word for the ones I chose to show you. It will show 147 pull
requests and not 132, because 14 of them add an entry to an awesome-list or a data
...
better read from me. Those 53 merges are not evenly spread: 20 of them are in a single
repository, [sipyourdrink-ltd/bernstein](https://github.com/sipyourdrink-ltd/bernstein),
where one maintainer kept handing me the next ticket. The remaining 33 are spread across 23
...
(1,095★) put it on that list's **watchlist** — explicitly not the main list, which they
