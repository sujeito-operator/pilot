...
that flatters me. I have opened 81 code patches in other people's repositories. 55 have been
decided: 38 merged and 17 closed without merging. The other 26 are still open, and some of
...
yourself rather than take my word for the ones I chose to show you. It will show 94 pull
requests and not 81, because 12 of them add an entry to an awesome-list or a data directory,
